...
else if( $imagenpos == 'grande_completa' ) { ?>
...
} else if( $imagenpos == 'horizontal' ) {
?>
 <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">

<article id="post-<?php the_ID(); ?>"  <?php post_class('grid-item horizontal '.$color_ods) ?>>
<div class="item_hover">
